...
void makeSelfCE(
	ContactElem& ce,
	bool isFV, const REAL3& norm,
	REAL w0, REAL w1,
	uchar type0, uchar type1, uchar type2, uchar type3,
	uint i0, uint i1, uint i2, uint i3)
{
	...
	ce._norm = norm;
#if 0
	ce._type[0] = type0;  ce._type[1] = type1;  ce._type[2] = type2;  ce._type[3] = type3;
	...
	if (isFV) {
		if (i0 < i1 && i0 < i2 && i1 < i2) {
			...
			ce._type[0] = type0;  ce._type[1] = type2;  ce._type[2] = type1;  ce._type[3] = type3;
			ce._i[0] = i0;  ce._i[1] = i2;  ce._i[2] = i1;  ce._i[3] = i3;
			ce._w[0] = w0;
			ce._w[1] = (1.0 - w0 - w1);
		}
		else if (i1 < i0 && i1 < i2 && i0 < i2) {
			ce._type[0] = type1;  ce._type[1] = type0;  ce._type[2] = type2;  ce._type[3] = type3;
			ce._i[0] = i1;  ce._i[1] = i0;  ce._i[2] = i2;  ce._i[3] = i3;
			ce._w[0] = w1;
			ce._w[1] = w0;
		}
		else if (i1 < i0 && i1 < i2 && i2 < i0) {
			ce._type[0] = type1;  ce._type[1] = type2;  ce._type[2] = type0;  ce._type[3] = type3;
			ce._i[0] = i1;  ce._i[1] = i2;  ce._i[2] = i0;  ce._i[3] = i3;
			ce._w[0] = w1;
			ce._w[1] = (1.0 - w0 - w1);
		}
		else if (i2 < i0 && i2 < i1 && i0 < i1) {
			ce._type[0] = type2;  ce._type[1] = type0;  ce._type[2] = type1;  ce._type[3] = type3;
			ce._i[0] = i2;  ce._i[1] = i0;  ce._i[2] = i1;  ce._i[3] = i3;
			ce._w[0] = (1.0 - w0 - w1);
			ce._w[1] = w0;
		}
		else if (i2 < i0 && i2 < i1 && i1 < i0) {
			ce._type[0] = type2;  ce._type[1] = type1;  ce._type[2] = type0;  ce._type[3] = type3;
		...
		if (type0 == type3) {
			if (i0 < i1 && i0 < i2 && i0 < i3 && i2 < i3) {
				...
				ce._type[0] = type0;  ce._type[1] = type1;  ce._type[2] = type3;  ce._type[3] = type2;
				...
				ce._type[0] = type1;  ce._type[1] = type0;  ce._type[2] = type3;  ce._type[3] = type2;
				ce._i[0] = i1;  ce._i[1] = i0;  ce._i[2] = i3;  ce._i[3] = i2;
				ce._w[0] = 1.0 - w0;
				ce._w[1] = 1.0 - w1;
			}
			else {
				ce._norm.x = -ce._norm.x;
				ce._norm.y = -ce._norm.y;
				ce._norm.z = -ce._norm.z;
				if (i2 < i0 && i2 < i1 && i2 < i3 && i0 < i1) {
					ce._type[0] = type2;  ce._type[1] = type3;  ce._type[2] = type0;  ce._type[3] = type1;
					ce._i[0] = i2;  ce._i[1] = i3;  ce._i[2] = i0;  ce._i[3] = i1;
					ce._w[0] = w1;
					ce._w[1] = w0;
				}
				else if (i2 < i0 && i2 < i1 && i2 < i3 && i1 < i0) {
					ce._type[0] = type2;  ce._type[1] = type3;  ce._type[2] = type1;  ce._type[3] = type0;
					ce._i[0] = i2;  ce._i[1] = i3;  ce._i[2] = i1;  ce._i[3] = i0;
					ce._w[0] = w1;
					ce._w[1] = 1.0 - w0;
				}
				else if (i3 < i0 && i3 < i1 && i3 < i2 && i0 < i1) {
					ce._type[0] = type3;  ce._type[1] = type2;  ce._type[2] = type0;  ce._type[3] = type1;
					ce._i[0] = i3;  ce._i[1] = i2;  ce._i[2] = i0;  ce._i[3] = i1;
					ce._w[0] = 1.0 - w1;
					ce._w[1] = w0;
				}
				else if (i3 < i0 && i3 < i1 && i3 < i2 && i1 < i0) {
					ce._type[0] = type3;  ce._type[1] = type2;  ce._type[2] = type1;  ce._type[3] = type0;
			...
			if (i0 < i1) {
				ce._type[0] = type0;  ce._type[1] = type1;
				ce._i[0] = i0;  ce._i[1] = i1;
				ce._w[0] = w0;
			}
			else {
				ce._type[0] = type1;  ce._type[1] = type0;
				ce._i[0] = i1;  ce._i[1] = i0;
				ce._w[0] = 1.0 - w0;
			}
			if (i2 < i3) {
				ce._type[2] = type2;  ce._type[3] = type3;
				ce._i[2] = i2;  ce._i[3] = i3;
				ce._w[1] = w1;
			}
			else {
				ce._type[2] = type3;  ce._type[3] = type2;
			...
			ce._norm.z = -ce._norm.z;
			if (i0 < i1) {
				ce._type[2] = type0;  ce._type[3] = type1;
				ce._i[2] = i0;  ce._i[3] = i1;
				ce._w[1] = w0;
			}
			else {
				ce._type[2] = type1;  ce._type[3] = type0;
				ce._i[2] = i1;  ce._i[3] = i0;
				ce._w[1] = 1.0 - w0;
			}
			if (i2 < i3) {
				ce._type[0] = type2;  ce._type[1] = type3;
				ce._i[0] = i2;  ce._i[1] = i3;
				ce._w[0] = w1;
			}
			else {
				ce._type[0] = type3;  ce._type[1] = type2;
				ce._i[0] = i3;  ce._i[1] = i2;
				ce._w[0] = 1.0 - w1;
			}
		}
	}
...
inline __device__ REAL getDistanceTV(
	...
	REAL delta, REAL3* normal = nullptr, REAL* wa = nullptr, REAL* wb = nullptr)
{
#if 0
	REAL result = REAL_MAX;
	REAL w0, w1;
...
{
	REAL result;
	if (isFV)	result = getDistanceTV(p0, p1, p2, p3, delta, normal, wa, wb);
	else		result = getDistanceEE(p0, p1, p2, p3, delta, normal, wa, wb);
	return result;
}
//-------------------------------------------------------------------------
//-------------------------------------------------------------------------
__device__ void getMeshElements_Detection_device(
	const ObjParam& param,
	uint iface, uint* inos,
	REAL3* ps, uchar* types,
	REAL& thickness)
{
	getIfromParam(param._fs, iface, inos);
	getXfromParam(param._ns, inos, ps);
	for (uint i = 0u; i < 3u; i++)
		types[i] = param._type;

	uint phase = param._nodePhases[inos[0]];
	thickness = param._thicknesses[phase];
}
__device__ void getParticleElements_Detection_device(
	const SPHParticleParam& param,
	uint ino, REAL3& p, uchar& type, REAL& thickness)
{
	getVector(param._xs, ino, p);
	type = param._type;

	uint phase = param._phases[ino];
	REAL s = param._ss[ino];
	thickness = param._radii[phase];
	thickness *= S3TO1(s) * 0.5;
}
//-------------------------------------------------------------------------
__device__ void getMeshElements_CCD_device(
	const ObjParam& param,
	uint iface, uint* inos,
	REAL3* ps, REAL3* qs, uchar* types,
	REAL& thickness, const REAL dt)
{
	getIfromParam(param._fs, iface, inos);
	getXfromParam(param._ns, inos, ps);
	getXfromParam(param._vs, inos, qs);
	for (uint i = 0u; i < 3u; i++) {
		qs[i] = ps[i] + qs[i] * dt;
		types[i] = param._type;
	}
...
__device__ void getParticleElements_CCD_device(
	const SPHParticleParam& param,
	uint ino, REAL3& p, REAL3& q, uchar& type, REAL& thickness,
	const REAL dt)
{
	getVector(param._xs, ino, p);
	getVector(param._vs, ino, q);
	q = p + q * dt;
	type = param._type;
